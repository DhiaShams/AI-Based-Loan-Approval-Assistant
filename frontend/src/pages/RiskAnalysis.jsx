...
export default function RiskAnalysis({ assessment }) {
  ...
  return <><PageHeader eyebrow="Risk analysis" title="Assessment result" description="A clear view of the risk prediction and the recommended decision." action={<Link className="mustard-button" to="/decision-explanation"><Sparkles size={16}/> View explanation</Link>} />
    ...
    <div className="notice"><ArrowUpRight size={18}/><span>The recommendation is based on the estimated default risk and the lender's approval guidelines.</span></div>
  </>;
}
